...
<body>
  ...
  <div class="new-arrival new-arrival-2 pt-110  pl-30">
    <div class="container">
      <div class="row">
        <div class="col-xl-6 col-lg-5 col-md-7">
          <div class="section-title ">
            <h2>latest products</h2>
            <p class="pr-125">Subscribe to our newsleter and stay up to date with
      ...
      <div class="arrival-product pt-45">
        <div class="row grid">
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 grid-item pr-0 cat1 cat4">
            <div class="arrival-items arrival-new-items  mb-55">
              <div class="arrival-img">
                <img src="img/products/15.png" alt="bag">
              </div>
          ...
          <div class="col-xl-3  col-lg-4 col-md-6 col-sm-6 grid-item mr-150 ml-140 cat3 cat2">
            <div class="arrival-items  mb-55">
              <div class="arrival-img">
                <img src="img/products/16.png" alt="Veranda Chair">
              </div>
              <div class="arrival-details position-relative pt-25">
                <h5><a href="shop_detalis.html">Veranda Chair</a></h5>
                <ul class="rating">
                  <li><i class="las la-star"></i></li>
                  <li><i class="las la-star"></i></li>
                  <li><i class="las la-star"></i></li>
          ...
          <div class="col-xl-3 pr-30 col-lg-4 col-md-6 col-sm-6 grid-item pl-0 cat4 cat2">
            <div class="arrival-items  mb-55">
              <div class="arrival-img">
                <img src="img/products/17.png" alt="Wooden Rings">
              </div>
              <div class="arrival-details position-relative pt-25">
                <h5><a href="shop_detalis.html">Wooden Rings</a></h5>
                <ul class="rating">
                  <li><i class="las la-star"></i></li>
                  <li><i class="las la-star"></i></li>
                  <li><i class="las la-star"></i></li>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 grid-item pr-0 cat3 cat4">
            <div class="arrival-items mb-55">
              <div class="arrival-img">
                <img src="img/products/18.png" alt="Leather Bag">
              </div>
              <div class="arrival-details arrival-details-variation position-relative pt-25">
                <h5><a href="shop_grid.html">Leather Bag</a></h5>

                <div class="price ">
                  <span>$219.00</span>
                  <div class="color-code float-right">
                    <span></span>
                    <span></span>
                  </div>
                </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 grid-item  mr-150 ml-140 cat1 cat3">
            <div class="arrival-items arrival-items2 mb-55">
              <div class="arrival-img">
                <img src="img/products/19.png" alt="Bronze Vase">
              </div>
              <div class="arrival-details position-relative pt-25">
                <h5><a href="shop_detalis.html">Bronze Vase</a></h5>
                <ul class="rating">
                  <li><i class="las la-star"></i></li>
                  <li><i class="las la-star"></i></li>
                  <li><i class="las la-star"></i></li>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 grid-item  pr-30 pl-0 cat1 cat2">
            <div class="arrival-items arrival-new-items arrival-sold-item ">
              <div class="arrival-img">
                <img src="img/products/20.png" alt="Women’s Trouser">
              </div>
              <div class="arrival-details position-relative pt-25">
                <h5><a href="shop_grid.html">Women’s Trouser</a></h5>
                <ul class="rating">
                  <li><i class="las la-star"></i></li>
                  <li><i class="las la-star"></i></li>
                  <li><i class="las la-star"></i></li>
  ...
  <div class="product-popupList product-popup2">
    <div class="product-popup shop-details position-relative">
      ...
      <div class="product-details ml-30 mt-70">
  ...
  <div class="today-deal today-deal-2 mt-115 pt-115 pb-115 pl-30">
    <div class="container">
      <div class="row">
        <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12">
          <div class="today-deal-img d-none d-md-block text-center position-relative pt-10">
            <img src="img/deals/2.png" alt="product">
          </div>
        </div>
        <div class="col-xl-5 col-lg-6 col-md-6 col-sm-12">
          <div class="deal-details  pt-80">
            <span class="text-uppercase">20% OFF</span>
            <div id="countdown" class="d-flex pb-15">
    ...
    <div class="container">
      <div class="brand-active">
        <div class="single-brand">
          <div class="brand-img">
            <img src="img/brand/1.png" alt="brand-logo">
          </div>
        </div>
        <div class="single-brand">
          <div class="brand-img">
            <img src="img/brand/2.png" alt="brand-logo">
          </div>
        </div>
        <div class="single-brand">
          <div class="brand-img">
            <img src="img/brand/3.png" alt="brand-logo">
          </div>
        </div>
        <div class="single-brand">
          <div class="brand-img">
            <img src="img/brand/4.png" alt="brand-logo">
          </div>
        </div>
        <div class="single-brand">
          <div class="brand-img">
            <img src="img/brand/5.png" alt="brand-logo">
          </div>
        </div>
        <div class="single-brand">
          <div class="brand-img">
  ...
  <!-- Brand Area Ends -->
  <!-- News Area Start -->
  <div class="news-area news-area-2 pl-30 pt-100">
    <div class="container">
      <div class="row">
        <div class="col-xl-5 col-lg-6 col-md-7">
          <div class="section-title  pb-45">
            <h2 class="text-uppercase">LATEST NEWS</h2>
            <p class="pr-5">Subscribe to our newsleter and stay up to date with
              latest offers and upcoming trends.</p>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-4 ">
          <div class="news-items mb-30 mb-md-0">
            <div class="news-img">
              <a href="blog.html"><img src="img/blog/4.png" alt="img1"></a>
            </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 ml-30 mr-60 ">
          <div class="news-items mb-30 mb-md-0">
            <div class="news-img">
              <a href="blog.html"><img src="img/blog/5.png" alt="img2"></a>
            </div>
            <div class="news-details pt-20">
              <div class="news-title pr-50">
                <a href="news_detalis.html">Lorem Ipsum has been the industry
        ...
        <div class="col-xl-3 col-lg-4 col-md-4 pl-xl-0 pr-xl-0 ">
          <div class="news-items">
            <div class="news-img">
              <a href="blog.html"><img src="img/blog/6.png" alt="img3"></a>
            </div>
            <div class="news-details pt-20">
  ...
  <div class="subscribe-area subscribe-area-2 pt-115 pl-30">
    <div class="container">
      <div class="row">
  ...
  <div class="instagram-area instagram-area-2 pt-110 pb-120">
    <div class="container">
    ...
    <div class="instagram-images d-flex pt-60">
      <div class="insta-imgs position-relative">
        <img src="img/instagram/5.png" alt="img">
        <a href="#"><i class="lab la-instagram"></i></a>
      </div>
      <div class="insta-imgs position-relative">
        <img src="img/instagram/6.png" alt="img">
        <a href="#"><i class="lab la-instagram"></i></a>
      </div>
      <div class="insta-imgs position-relative">
        <img src="img/instagram/7.png" alt="img">
        <a href="#"><i class="lab la-instagram"></i></a>
      </div>
      <div class="insta-imgs position-relative">
        <img src="img/instagram/8.png" alt="img">
        <a href="#"><i class="lab la-instagram"></i></a>
      </div>
      <div class="insta-imgs position-relative">
        <img src="img/instagram/9.png" alt="img">
        <a href="#"><i class="lab la-instagram"></i></a>
      </div>
      <div class="insta-imgs position-relative">
        <img src="img/instagram/10.png" alt="img">
        <a href="#"><i class="lab la-instagram"></i></a>
      </div>
      <div class="insta-imgs position-relative">
        <img src="img/instagram/11.png" alt="img">
        <a href="#"><i class="lab la-instagram"></i></a>
      </div>
      <div class="insta-imgs position-relative">
        <img src="img/instagram/12.png" alt="img">
        <a href="#"><i class="lab la-instagram"></i></a>
      </div>
          ...
          <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6">
            <div class="footer-widget mb-30 mb-lg-0 pt-15">
              <div class="logo pb-30">
                <a href="index.html"><img src="img/logo/logo-white.png" alt="logo"></a>
              </div>
