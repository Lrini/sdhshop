...
$data = mysqli_query($koneksi,"insert into user (nama,alamat,no_hp,email,pass,level,status,id_kelas) values ('$nama','$alamat','$no_hp','$email','$password','user','pasif','$kelas')");
